...
const addNotSupportedComments = (j, source) => {
    ...
    if (clientNamesFromDeepImport.includes(config_1.DYNAMODB)) {
        ...
        (0, getNodesWithDocClientNamedImportFromDeepPath_1.getNodesWithDocClientNamedImportFromDeepPath)(j, source).forEach((node) => {
