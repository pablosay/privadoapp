...
const getDynamoDBDocClientArgs = (j, v2DocClientNewExpression, options) => {
    ...
    return [
        (0, getDynamoDBForDocClient_1.getDynamoDBForDocClient)(j, v2DocClientNewExpression, options),
