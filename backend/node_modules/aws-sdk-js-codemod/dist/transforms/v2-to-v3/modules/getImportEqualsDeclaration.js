...
const getImportEqualsDeclaration = (j, source, options) => {
    ...
    return source
        ...
        if (expressionValue === config_1.PACKAGE_NAME && identifierName === options.v2GlobalName) {
            return true;
        }
        if (expressionValue === (0, utils_1.getClientDeepImportPath)(options.v2ClientName) &&
