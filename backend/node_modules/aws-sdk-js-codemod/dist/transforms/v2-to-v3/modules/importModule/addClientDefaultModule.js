...
exports.addClientDefaultModule = void 0;
const utils_1 = require("../../utils");
const getImportDeclaration_1 = require("../getImportDeclaration");
const getImportSpecifiers_1 = require("../getImportSpecifiers");
const addClientDefaultModule = (j, source, { v2ClientLocalName, v2ClientName, v3ClientPackageName }) => {
    ...
    const v3ImportDeclaration = j.importDeclaration([importNamespaceSpecifier], j.stringLiteral(v3ClientPackageName));
...
exports.addClientDefaultModule = addClientDefaultModule;
